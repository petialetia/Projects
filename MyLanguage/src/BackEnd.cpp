...
void TranslateComparingNode (tree_node* current_node, FILE* output_file, translate_info* translate_info, size_t num)
{
    ...
    {
        case ABOVE_OR_EQUAL: fprintf (output_file, "jb :%zu\n", num);    //
                             break;

        case BELOW_OR_EQUAL: fprintf (output_file, "ja :%zu\n", num);
                             break;

        case ABOVE:          fprintf (output_file, "jbe :%zu\n", num);
                             break;

        case BELOW:          fprintf (output_file, "jae :%zu\n", num);
                             break;

        case EQUAL:          fprintf (output_file, "jne :%zu\n", num);
                             break;

        case NOT_EQUAL:      fprintf (output_file, "je :%zu\n", num);
                             break;
