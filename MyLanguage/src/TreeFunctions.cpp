#include "../include/TreeFunctions.hpp"
...
void PrintNodesDescription (FILE* graphviz_file, tree_node* current_node, node_type_info* node_type_info)
{
    ...
    fprintf (graphviz_file, "\"%p\" [style=\"filled\", fillcolor=\"#", (void*)current_node);
    ...
    {                                                                                                              \
        ...
        fprintf (graphviz_file, "\"%p\" -> \"%p\"\n", (void*)current_node, (void*)current_node->direction##_child);\
    }
