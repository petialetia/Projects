...
Also there is processing of current line length, so lines won't be too long. Shift to the next line is perfomed correctly, even if there wasn't shift in original text.
